...
parseOutputMode =
  ...
  <|> flag' (Haskell (HS.LazySmallCheck Nothing))
        (long "haskell-lazysc" <> help "Haskell output with LazySmallCheck tests")
  <|> fmap (Haskell . HS.LazySmallCheck . Just)
        (option auto $ long "haskell-lazysc-depth" <> help "Haskell output with LazySmallCheck tests up to some depth" <> metavar "DEPTH")
  <|> fmap (Haskell . HS.Smten)
        (option auto $ long "haskell-smten" <> help "Haskell output with Smten" <> metavar "DEPTH")
