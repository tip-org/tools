...
parseOutputMode =
  ...
  <|> flag' (Haskell (HS.QuickSpec (HS.QuickSpecParams {foreground_functions = Nothing, predicates = Nothing, max_size = 7, use_observers = False})))      (long "haskell-spec"   <> help "Haskell output with QuickSpec signature (Feat generators)")
