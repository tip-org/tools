...
parseOutputMode =
  ...
  <|> flag' (Haskell (HS.QuickSpec (HS.QuickSpecParams {foreground_functions = [], use_observers = False})))      (long "haskell-spec"   <> help "Haskell output with QuickSpec signature (Feat generators)")
