...
Decl
  : 'declare-datatype' AttrSymbol Datatype { Tip.Parser.AbsTIP.DeclareDatatype $2 $3 }
...
Assertion
  : 'assert' { Tip.Parser.AbsTIP.Assert }
...
Type
  : Symbol { Tip.Parser.AbsTIP.TyVar $1 }
...
Expr
  : PolySymbol { Tip.Parser.AbsTIP.Var $1 }
...
Binder
  : 'lambda' { Tip.Parser.AbsTIP.Lambda }
...
Head
  : PolySymbol { Tip.Parser.AbsTIP.Const $1 }
...
PolySymbol
  : Symbol { Tip.Parser.AbsTIP.NoAs $1 }
...
Attr
  : Keyword { Tip.Parser.AbsTIP.NoValue $1 }
...
Symbol
  : UnquotedSymbol { Tip.Parser.AbsTIP.Unquoted $1 }
